  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <label className="space-y-2">
        ...
        >
          <option value="All">All prices (${minPrice} - ${maxPrice})</option>
          <option value="0-500">Budget under $500</option>
          <option value="501-950">Mid-range $501 - $950</option>
          <option value="951-1500">Premium $951 - $1500</option>
        </select>
      </label>
